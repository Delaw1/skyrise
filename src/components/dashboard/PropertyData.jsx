                        ...
                        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img className="d-block w-100" src="images/prj-s1.jpg" alt="First slide" />
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block w-100" src="images/house-det.jpg" alt="Second slide" />
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block w-100" src="images/prj-s1.jpg" alt="Third slide" />
                                </div>
                            </div>
                        ...
                        <div className="w-100">
                            <div className="row">
                                <div className="col-6">
                                    ...
                                    <span className="list-dis">32 units</span>
                                    <span className="list-head">Townhouse:</span>
                                    <span className="list-dis m-bt">6 units</span>
                                </div>
