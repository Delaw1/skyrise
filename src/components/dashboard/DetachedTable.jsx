        ...
        <table className="prj-list">
            <thead>
                <tr>
                    ...
                    <th width="20%" scope="col" className="text-right">Developer</th>
                </tr>
            </thead>
            <tbody>
                {Array.isArray(body) ?
                    body.length === 0 ? '' :
                        body.map((project, i) =>
                            <tr key={i}>
                                ...
                                <td data-label="Developer" className="text-right">{project.developer.name}</td>
                            </tr>
                        )
                    : 'Loading'}
            </tbody>
