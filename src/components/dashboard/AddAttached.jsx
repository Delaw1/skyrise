    ...
    return (
      ...
      Upload Photo
                ...
                <div className="custom-control custom-checkbox mt-2 p-new">
                        <CheckBox id="customCheckBox2" inputClass="custom-control-input" name="Featured project" click={() => this.handleCheck("featured")} check={this.state.featured} labelClass="custom-control-label pt-1 text-dark" />
                      </div> 
                    </label>
